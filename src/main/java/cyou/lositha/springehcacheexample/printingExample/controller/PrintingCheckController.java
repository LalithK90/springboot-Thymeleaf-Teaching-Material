package cyou.lositha.springehcacheexample.printingExample.controller;
...
import cyou.lositha.springehcacheexample.employeeCrud.controller.EmployeeController;
import cyou.lositha.springehcacheexample.printingExample.service.PrintingCheckService;
...
public class PrintingCheckController extends HttpServlet {
    ...
    @GetMapping("/fileView")
    public String fileRequestOne(Model model, HttpServletRequest request) {
        /*
