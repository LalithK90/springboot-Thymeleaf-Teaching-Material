package cyou.lositha.springehcacheexample.hibernate.oneToOneBi.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RestController;

import cyou.lositha.springehcacheexample.hibernate.oneToOneBi.entity.InstructorDetailOneToOneBi;
import cyou.lositha.springehcacheexample.hibernate.oneToOneBi.entity.InstructorOneToOneBi;
import cyou.lositha.springehcacheexample.hibernate.oneToOneBi.service.InstructorOneToOneBiService;
...
public class OneToOneBiController {
    ...
    public void oneToOneUniCreate() {
        // create the objects
        InstructorOneToOneBi tempInstructor = new InstructorOneToOneBi("Asanka", "Lalith", "as@gmail.com");

        InstructorDetailOneToOneBi tempInstructorDetail = new InstructorDetailOneToOneBi(
                "http://www.example.com/youtube",
                "Cricket");

        InstructorOneToOneBi tempInstructor1 = new InstructorOneToOneBi("Nuwan ", "Bandara", "nuwan@gamil.com");

        InstructorDetailOneToOneBi tempInstructorDetail1 = new InstructorDetailOneToOneBi(
                "http://www.example.com/youtube",
                "Guitar");
