...
public class EmployeePdfAndExcelRestController {
    ...
    public void createEmployeePdfAndExcel() {
        ...
        employee.setGender(genderService.findById(5));
        ...
        employee1.setGender(genderService.findById(5));
        ...
        employee2.setGender(genderService.findById(5));
        ...
        employee3.setGender(genderService.findById(6));
        ...
        employee4.setGender(genderService.findById(6));
        ...
        employee5.setGender(genderService.findById(6));
        ...
        employee6.setGender(genderService.findById(6));
        ...
        employee7.setGender(genderService.findById(5));
        ...
        employee8.setGender(genderService.findById(6));
        ...
        employee9.setGender(genderService.findById(6));
