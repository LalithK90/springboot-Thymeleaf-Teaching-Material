...
import lk.lalithk90.springbootthymelaf.employeeCrud.service.GenderService;
...
public class EmployeePdfAndExcelRestController {
    ...
    public void createEmployeePdfAndExcel() {
        ...
        employee.setGender(genderService.findById(1));
        ...
        employee1.setGender(genderService.findById(1));
        ...
        employee2.setGender(genderService.findById(1));
        ...
        employee3.setGender(genderService.findById(1));
        ...
        employee4.setGender(genderService.findById(1));
        ...
        employee5.setGender(genderService.findById(1));
        ...
        employee6.setGender(genderService.findById(1));
        ...
        employee7.setGender(genderService.findById(1));
        ...
        employee8.setGender(genderService.findById(1));
        ...
        employee9.setGender(genderService.findById(1));
